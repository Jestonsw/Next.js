  ...
  const handleEventImageChange = (e: React.ChangeEvent<HTMLInputElement>, index: number) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        if (index === 0) {
          setEventSubmission({...eventSubmission, imageUrl: result})
        } else if (index === 1) {
          setEventSubmission({...eventSubmission, imageUrl2: result})
        } else if (index === 2) {
          setEventSubmission({...eventSubmission, imageUrl3: result})
        }
      }
  ...
  const handleVenueImageChange = (e: React.ChangeEvent<HTMLInputElement>, index: number) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        const result = e.target?.result as string
        if (index === 0) {
          setVenueSubmission({...venueSubmission, imageUrl: result})
        } else if (index === 1) {
          setVenueSubmission({...venueSubmission, imageUrl2: result})
        } else if (index === 2) {
          setVenueSubmission({...venueSubmission, imageUrl3: result})
        }
      }
      reader.readAsDataURL(file)
    }
...
"${userData.name}" hesabını silmek için telefon numaranızı yazın:`
  ...
  const formatPhoneDisplay = (digits: string) => {
    ...
    if (!digits || digits.length === 0) {
      return '0___ ___ __ __'
    }
    
    const paddedDigits = digits.padEnd(10, '_')
    
    // Format: 0___ ___ __ __
    let display = '0'
    display += paddedDigits.slice(0, 3) // ___ or XXX
    display += ' ' + paddedDigits.slice(3, 6) // ___ or XXX
    display += ' ' + paddedDigits.slice(6, 8) // __ or XX
    display += ' ' + paddedDigits.slice(8, 10) // __ or XX
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, title: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
              ...
              <div className="md:col-span-2">
                ...
                <textarea 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, description: e.target.value})}
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, startDate: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
                  required
                />
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, endDate: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
                />
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, startTime: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
                />
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, endTime: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
                />
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, location: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, address: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, organizerName: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, organizerContact: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, capacity: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, websiteUrl: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setEventSubmission({...eventSubmission, ticketUrl: e.target.value})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setEventSubmission({...eventSubmission, submitterName: e.target.value})}
                    className="w-full p-3 border border-gray-300 rounded-lg"
                ...
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => setEventSubmission({...eventSubmission, submitterEmail: e.target.value})}
                    className="w-full p-3 border border-gray-300 rounded-lg"
                    placeholder="ornek@email.com"
                    required
                  />
                      ...
                      onKeyDown={(e) => {
                        if (e.key >= '0' && e.key <= '9') {
                          ...
                          if (currentDigits.length < 10) {
                            setEventSubmission({...eventSubmission, submitterPhone: currentDigits + e.key})
                          }
                        } else if (e.key === 'Backspace') {
                          e.preventDefault()
                          const currentDigits = eventSubmission.submitterPhone.replace(/[^0-9]/g, '')
                          if (currentDigits.length > 0) {
                            setEventSubmission({...eventSubmission, submitterPhone: currentDigits.slice(0, -1)})
                          }
                        }
                      }}
                      onFocus={(e) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select 
                  ...
                  onChange={(e) => setVenueSubmission({...venueSubmission, categoryId: Number(e.target.value)})}
                  className="w-full p-3 border border-gray-300 rounded-lg"
                  ...
                  <input 
                    ...
                    onKeyDown={(e) => {
                      if (e.key >= '0' && e.key <= '9') {
                        ...
                        if (currentDigits.length < 10) {
                          setVenueSubmission({...venueSubmission, phone: currentDigits + e.key})
                        }
                      } else if (e.key === 'Backspace') {
                        e.preventDefault()
                        const currentDigits = venueSubmission.phone.replace(/[^0-9]/g, '')
                        if (currentDigits.length > 0) {
                          setVenueSubmission({...venueSubmission, phone: currentDigits.slice(0, -1)})
                        }
                      }
                    }}
                    onFocus={(e) => {
                    ...
                    <input 
                      ...
                      onKeyDown={(e) => {
                        if (e.key >= '0' && e.key <= '9') {
                          ...
                          if (currentDigits.length < 10) {
                            setVenueSubmission({...venueSubmission, submitterPhone: currentDigits + e.key})
                          }
                        } else if (e.key === 'Backspace') {
                          e.preventDefault()
                          const currentDigits = venueSubmission.submitterPhone.replace(/[^0-9]/g, '')
                          if (currentDigits.length > 0) {
                            setVenueSubmission({...venueSubmission, submitterPhone: currentDigits.slice(0, -1)})
                          }
                        }
                      }}
                      className="w-full p-3 border border-gray-300 rounded-lg"
